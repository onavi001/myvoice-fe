    ...
    <div className="min-h-screen bg-[#1A1A1A] text-[#E0E0E0] flex flex-col">
      <div className="p-4 sm:p-6 max-w-3xl mx-auto flex-1">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold">Crear Nueva Rutina</h1>
          <Button
            variant="secondary"
            onClick={toggleAll}
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              ...
              className="w-full bg-[#EF5350] text-[#E0E0E0] hover:bg-[#D32F2F] rounded-lg py-3 px-4 text-sm font-semibold border border-[#D32F2F] shadow-md transition-colors"
            >
              Cancelar
            </Button>
          </div>

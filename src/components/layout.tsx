...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const { adTopInset, adBottomInset, contentPaddingTop, contentPaddingBottom } =
    useAdMobBanner(Boolean(token));

  return (
    <AdMobInsetContext.Provider value={{ top: adTopInset, bottom: adBottomInset }}>
